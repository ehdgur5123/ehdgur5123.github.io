...
|숙소                             | 338,473원      | 6박             | 2,030,838원         |○               | 
|숙소(관광세)                      |   25,010원     | 6박             | 예상 150,060원      |X 현장결제       | 
|뮤지엄패스(4일권)                 |                | 2               |                     |X               | 
|몽생미셸 투어신청                 |                | 2               |                     |X               | 
...
|세인트(생트)샤펠    | 2025년 03월 01일(토) | ○      |15:00PM  |         
...
1. 호텔명: 파리 호텔 투어리즘 애브뉴 Hotel Tourism Avenue
2. 주소: 66, Avenue de La Motte Picquet, Paris, Paris, 프랑스, 75015
3. 일정: 체크인 2월27일 15:00, 체크아웃 3월05일 *12:00* 총 6박
...
4. 예약사이트: 마이리얼트립[👉 파리 호텔 투어리즘 애브뉴](https://accommodation.myrealtrip.com/union/products/1207396?checkIn=2025-02-11&checkOut=2025-02-12&adultCount=2&childCount=0&isDomestic=false&providerRoomId=&childAges=)

5. 숙소를 예약하면, 숙소비와는 별도로 체크아웃할 때, **현지세**를 지불해야 함.(1인당 1박에 약 8.4유로로 6박 2인 총 **15만원** 정도 예상)

6. 현지세는 대부분의 호텔에 부과되며, 호텔에서 현금 또는 카드로 지불하는 방식으로 처리됩니다. 예약 시 명시된 숙박 요금 외에 추가 비용을 고려하는 것이 좋습니다.

7. Reference

  - [👉 파리 호텔 투어리즘 애브뉴 공식 홈페이지](https://www.hoteltourismeavenue.com/)
  - [👉 파리 호텔 투어리즘 애브뉴 후기](https://blog.naver.com/iamhy_p/223469517548)

## 4. 파리지앵 크루즈(Privilege)
...
1. [👉 아시아나 항공 운송 제한 물품 확인](https://www.myrealtrip.com/offers/126240)
2. [👉 항공보안 365 기내 반입금지물품 검색](https://www.avsec365.or.kr/avsc/main.do#)
...
8. **파리 esim**[👉 파리 esim 구매하기](https://www.myrealtrip.com/offers/126240)
...
<table>
  ...
  <thead>
    <tr>
      <th scope="col">일 정</th>
      <th scope="col">02.27</th>
      <th scope="col">02.28</th>
      <th scope="col">03.01</th>
...
<table>
  ...
  <tbody>
    ...
    <script>
      const startHour = 7;
      const endHour = 22;
      const days = ["Feb 27", "Feb 28", "Mar 1", "Mar 2", "Mar 3", "Mar 4", "Mar 5"];
      for (let hour = startHour; hour <= endHour; hour++) {
          const ampm = hour < 12 ? "AM" : "PM";
          const displayHour = hour <= 12 ? hour : hour - 12;
          document.write('<tr>');
          document.write(`<td>${displayHour}:00 ${ampm}</td>`);
          days.forEach(() => {
